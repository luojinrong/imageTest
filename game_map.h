...
public:
    ...
    void get_data(int level){
        ...
        v.clear();
        if(level==0){
           ifs.open("./rank/rank_level_1.txt");
        }
        else if(level==1){
            ifs.open("./rank/rank_level_2.txt");
        }
        else if(level==2){
            ifs.open("./rank/rank_level_3.txt");
        }
        if(ifs.is_open()){
            for(int i=0;i<5;++i){
                int data;
    ...
    void fill_operator(){
        ...
        v.clear();
        if(level==1){
           ex.open("./rank/rank_level_1.txt");
        }
        else if(level==2){
            ex.open("./rank/rank_level_2.txt");
        }
        else if(level==3){
            ex.open("./rank/rank_level_3.txt");
        }
        if(ex.is_open()){
            for(int i=0;i<5;++i){
                int data;
        ...
        ofstream exe;
        if(level==1){
            exe.open("./rank/rank_level_1.txt");
        }
        else if(level==2){
            exe.open("./rank/rank_level_2.txt");
        }
        else if(level==3){
            exe.open("./rank/rank_level_3.txt");
        }
        else{
            return ;
        }
